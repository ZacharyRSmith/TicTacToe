...
ActiveRecord::Schema.define(version: 20150129150234) do
  ...
  create_table "lines", force: true do |t|
    t.string   "status"  # For AI purposes.
    t.datetime "created_at", null: false
    t.datetime "updated_at", null: false
    t.integer  "board_id"
  end
  ...
  create_table "squares", force: true do |t|
    ...
    t.string   "mark",        null: false  # E.g.: "X", "Y", "_" (blank),
      # "~" for an un-markable square.
    t.integer  "ai_priority" # How highly the AI ranks this square.
  end
